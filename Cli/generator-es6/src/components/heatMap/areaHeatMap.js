...
import mapJson from './mapJson/chongqing.json'
...
import AddMarks from './addMarks.js'
...
export default class AreaHeatMap {
  ...
  constructor(selector, opt) {
    ...
    let root = feature(mapJson, mapJson.objects.chongqing) 
    ...
    // 合并主城区
    this.mainData = merge(mapJson, 
      mapJson.objects.chongqing.geometries.filter((d) => {
    ...
    if(mark) {
      // 添加地区名字，实例化
      this.names = new AddMarks(selector, this.config)
